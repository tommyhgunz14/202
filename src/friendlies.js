...
import { loadOrPlaceholder, findAllNamed } from './loader.js?v=202609171534';
import { toWorld, KT, MPH } from './config.js?v=202609171534';
import { AIRCRAFT } from './data/aircraft.js?v=202609171534';
