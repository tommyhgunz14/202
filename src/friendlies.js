...
import { loadOrPlaceholder, findAllNamed } from './loader.js?v=202609171515';
import { toWorld, KT, MPH } from './config.js?v=202609171515';
import { AIRCRAFT } from './data/aircraft.js?v=202609171515';
