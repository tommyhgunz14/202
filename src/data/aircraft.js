...
export const AIRCRAFT = {
  london: {
    ...
    stores: { kind: '250 lb anti-submarine bomb', count: 8, label: 'A/S bombs' },
    asv: false,
  ...
  swordfish: {
    ...
    stores: { kind: '250 lb anti-submarine bomb', count: 2, label: 'A/S bombs' },
    asv: false,
  ...
  catalina: {
    ...
    stores: { kind: '250 lb Mk VIII depth charge', count: 4, label: 'depth charges' },
    asv: true,
