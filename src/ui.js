  ...
  render() {
    ...
    if (s === 'title') {
      html = `<div class="title-card">
        <figure class="badge">
          <img src="assets/ui/badge_202.webp" alt="A No. 202 Squadron badge: a Short Sunderland flying boat in a ring reading Royal Air Force, 202 Squadron, under the crown, with the motto Semper Vigilate">
