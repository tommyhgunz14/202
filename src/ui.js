import { AIRCRAFT, SCORE_LABELS, availableOn } from './data/aircraft.js?v=202609171515';
import { MISSIONS, PILOT } from './data/missions.js?v=202609171515';
import { PLANS, DEFAULT_PLAN } from './data/plans.js?v=202609171515';
import { PLATES } from './data/archive.js?v=202609171515';
import { PACE } from './pace.js?v=202609171515';
  ...
  render() {
    ...
    if (s === 'title') {
      html = `<div class="title-card">
        <figure class="badge">
          <img src="assets/ui/badge_202.webp" alt="A No. 202 Squadron badge: a Short Sunderland flying boat in a ring reading British Air Force, 202 Squadron, with the motto Semper Vigilate on a scroll">
      ...
      html = `<div class="card wide"><h2>Sources &amp; accuracy</h2>
        ...
        <table class="spec">
          <tr><td>Sep 1939</td><td>Wg Cdr E. A. Blake brings the squadron to Gibraltar and forms it there with six Saro London Mk II</td></tr>
          <tr><td>3 Mar 1940</td><td>Wg Cdr Alfred Rogers assumes command; still in post when Italy enters the war on 10 June</td></tr>
          <tr><td>end Jul 1940</td><td><b>Sqn Ldr T. Horner</b> becomes the new commanding officer &mdash; the player</td></tr>
          <tr><td>28 Jan 1941</td><td>The record calls him <b>Wing Commander</b> Horner, flying London K5909 off Casablanca when two Vichy Hawk 75s bounce him; he brings her home with bullet holes. The promotion falls somewhere between these two dates; the exact day is not recorded</td></tr>
          <tr><td>Feb 1942</td><td>Wg Cdr Albert Case takes command; he flies the Catalina that lifts Maj Gen Mark Clark off a submarine on 24 October 1942</td></tr>
          <tr><td>by Jan 1944</td><td>Wg Cdr G. Harger in command</td></tr>
          <tr><td>Sep 1944</td><td>The squadron leaves Gibraltar after five years</td></tr>
        </table>
        <p class="small">The command dates come from Andrew Thomas, &ldquo;Guardians from the Rock&rdquo; (Britain at War / Key Military), read in full. The one thing still not recorded is the exact day Horner&rsquo;s promotion came through: the article has him a squadron leader at the end of July 1940 and a wing commander by 28 January 1941, so the game places the moment at the front of that January sortie and says so rather than inventing a date.</p>
