...
t = rep(t, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171221';`, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171221';
import { loadTex, terrainDetail } from './textures.js?v=202609171221';`, 'import');
...
b = rep(b, `import { terrainHeight } from './terrain.js?v=202609171221';`, `import { terrainHeight } from './terrain.js?v=202609171221';
import { planarUVs, texture } from './textures.js?v=202609171221';
...
h = rep(h, `import { terrainHeight } from './terrain.js?v=202609171221';`, `import { terrainHeight } from './terrain.js?v=202609171221';
import { planarUVs, texture } from './textures.js?v=202609171221';`, 'import');
...
a = rep(a, `export class Audio {
  ...
  }`, `import { Samples } from './samples.js?v=202609171221';
