...
t = rep(t, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js';`, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js';
import { loadTex, terrainDetail } from './textures.js';`, 'import');
...
b = rep(b, `import { terrainHeight } from './terrain.js';`, `import { terrainHeight } from './terrain.js';
...
h = rep(h, `import { terrainHeight } from './terrain.js';`, `import { terrainHeight } from './terrain.js';
import { planarUVs, texture } from './textures.js';`, 'import');
