...
t = rep(t, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171515';`, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171515';
import { loadTex, terrainDetail } from './textures.js?v=202609171515';`, 'import');
...
b = rep(b, `import { terrainHeight } from './terrain.js?v=202609171515';`, `import { terrainHeight } from './terrain.js?v=202609171515';
...
h = rep(h, `import { terrainHeight } from './terrain.js?v=202609171515';`, `import { terrainHeight } from './terrain.js?v=202609171515';
import { planarUVs, texture } from './textures.js?v=202609171515';`, 'import');
