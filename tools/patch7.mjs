...
t = rep(t, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171608';`, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171608';
import { loadTex, terrainDetail } from './textures.js?v=202609171608';`, 'import');
...
b = rep(b, `import { terrainHeight } from './terrain.js?v=202609171608';`, `import { terrainHeight } from './terrain.js?v=202609171608';
import { planarUVs, texture } from './textures.js?v=202609171608';
...
h = rep(h, `import { terrainHeight } from './terrain.js?v=202609171608';`, `import { terrainHeight } from './terrain.js?v=202609171608';
import { planarUVs, texture } from './textures.js?v=202609171608';`, 'import');
...
a = rep(a, `export class Audio {
  ...
  }`, `import { Samples } from './samples.js?v=202609171608';
