...
t = rep(t, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171124';`, `import { toWorld, H_SCALE, V_SCALE, WORLD_HALF } from '../config.js?v=202609171124';
import { loadTex, terrainDetail } from './textures.js?v=202609171124';`, 'import');
...
b = rep(b, `import { terrainHeight } from './terrain.js?v=202609171124';`, `import { terrainHeight } from './terrain.js?v=202609171124';
import { planarUVs, texture } from './textures.js?v=202609171124';
...
h = rep(h, `import { terrainHeight } from './terrain.js?v=202609171124';`, `import { terrainHeight } from './terrain.js?v=202609171124';
import { planarUVs, texture } from './textures.js?v=202609171124';`, 'import');
...
a = rep(a, `export class Audio {
  ...
  }`, `import { Samples } from './samples.js?v=202609171124';
