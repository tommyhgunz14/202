...
- **Gibraltar at double scale**: aircraft and ships are true size, so at 4:1 the Rock and the harbour looked a quarter as long as they should beside them. Within about 3.6 km of Gibraltar the map is drawn at 2:1, easing back to 4:1 over the next 6 km ( in ). Everything further out keeps its shape and the distances between its places, but sits about 1.65 km of game distance further from Gibraltar. Distances shown on the radar and plot are therefore generous close to Gibraltar.
