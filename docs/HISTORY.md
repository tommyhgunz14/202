...
| Badge on the title screen, with the motto *Semper Vigilate*, "Be always vigilant" (Latin *semper*, always; *vigilate*, keep watch, a plural command addressed to all). The artwork was supplied to the project and cut out from its background for the title screen (the lower edge of its scroll, which ran off the supplied image, was completed). It is a tribute rather than the official badge: it carries no crown, its ring reads "British Air Force" rather than naming the service, and in the centre is a Short Sunderland, the type the squadron flew from the Rock alongside its Catalinas, where the squadron's approved device is a mallard alighting. | Supplied artwork |
